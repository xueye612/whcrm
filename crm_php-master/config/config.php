...
return [
    ...
    //允许访问模块
    'allow_module_list'      => ['admin','crm','oa','bi','work','finance','ledger'],    
    // 默认控制器名
    ...
    'url_route_on'           => true,
    // 路由配置文件（支持配置多个）
    'route_config_file'      => ['route_admin','route_crm','route_oa','route_bi','route_work','route_finance','route_ledger'],
    // 是否强制使用路由
