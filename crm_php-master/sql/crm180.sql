/*
 ...
 Source Schema         : crm180

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 27/01/2026 21:39:12
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字段操作记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_admin_action_record
-- ----------------------------
INSERT INTO `5kcrm_admin_action_record` VALUES (1, 1, 1769157616, 'crm_customer', 1, '创建了客户');
INSERT INTO `5kcrm_admin_action_record` VALUES (2, 1, 1769176961, 'crm_customer', 1, '将 \'成交状态\' 由 未成交 修改为 已成交');
INSERT INTO `5kcrm_admin_action_record` VALUES (3, 1, 1769309931, 'crm_contacts', 1, '创建了联系人');
INSERT INTO `5kcrm_admin_action_record` VALUES (4, 1, 1769309948, 'crm_contract', 1, '创建了合同');
INSERT INTO `5kcrm_admin_action_record` VALUES (5, 1, 1769318003, 'crm_customer', 2, '创建了客户');
INSERT INTO `5kcrm_admin_action_record` VALUES (6, 1, 1769506200, 'crm_customer', 1, '将 \'客户简称\' 由 空 修改为 文汇');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '审批记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_admin_examine_record
-- ----------------------------
INSERT INTO `5kcrm_admin_examine_record` VALUES (1, 'crm_contract', 1, 11, 1, 1, 1769309955, 1, '', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 120 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '自定义字段表' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_admin_field` VALUES (14, 'crm_customer', 0, 'name', '客户名称', 'text', '', 0, 1, 1, '', '', 1, 189, 1553788800, 1769506169, 1, '', 0, 50, '0,0', 0, '', '', '', '', 1034);
INSERT INTO `5kcrm_admin_field` VALUES (15, 'crm_customer', 0, 'level', '客户级别', 'select', '', 0, 0, 0, '', 'A（重点客户）\nB（普通客户）\nC（非优先客户）', 3, 191, 1553788800, 1769506169, 3, '', 0, 50, '1,0', 2, '', '', '', 'A（重点客户）,B（普通客户）,C（非优先客户）', 1035);
INSERT INTO `5kcrm_admin_field` VALUES (16, 'crm_customer', 0, 'industry', '客户行业', 'select', '', 0, 0, 0, '', 'IT/通信/电子/互联网\n金融业\n房地产\n商业服务\n贸易\n生产\n运输/物流\n服务业\n文化传媒\n政府', 2, 191, 1553788800, 1769506169, 3, '', 0, 50, '0,1', 2, '', '', '', 'IT/通信/电子/互联网,金融业,房地产,商业服务,贸易,生产,运输/物流,服务业,文化传媒,政府', 1025);
INSERT INTO `5kcrm_admin_field` VALUES (17, 'crm_customer', 0, 'source', '客户来源', 'select', '', 0, 0, 0, '', '促销活动\n搜索引擎\n广告\n转介绍\n线上注册\n线上询价\n预约上门\n陌拜\n招商资源\n公司资源\n展会资源\n个人资源\n电话咨询\n邮件咨询', 4, 191, 1553788800, 1769506169, 3, '', 0, 50, '1,1', 2, '', '', '', '促销活动,搜索引擎,广告,转介绍,线上注册,线上询价,预约上门,陌拜,招商资源,公司资源,展会资源,个人资源,电话咨询,邮件咨询', 1026);
...
INSERT INTO `5kcrm_admin_field` VALUES (19, 'crm_customer', 0, 'telephone', '电话', 'text', '', 0, 0, 0, '', '', 5, 191, 1553788800, 1769506169, 1, '', 0, 50, '2,0', 0, '', '', '', '', 1027);
INSERT INTO `5kcrm_admin_field` VALUES (20, 'crm_customer', 0, 'website', '网址', 'text', '', 0, 0, 0, '', '', 8, 191, 1553788800, 1769506169, 1, '', 0, 50, '3,1', 0, '', '', '', '', 1028);
INSERT INTO `5kcrm_admin_field` VALUES (21, 'crm_customer', 0, 'next_time', '下次联系时间', 'datetime', '', 0, 0, 0, '', '', 10, 63, 1553788800, 1769506169, 13, '', 0, 50, '5,0', 0, '', '', '', '', 1029);
INSERT INTO `5kcrm_admin_field` VALUES (22, 'crm_customer', 0, 'remark', '备注', 'textarea', '', 0, 0, 0, '', '', 11, 191, 1553788800, 1769506169, 2, '', 0, 50, '5,1', 0, '', '', '', '', 1030);
...
INSERT INTO `5kcrm_admin_field` VALUES (99, 'crm_customer', 0, 'mobile', '手机', 'mobile', '', 0, 0, 0, '', '', 6, 191, 1553788800, 1769506169, 7, '', 0, 50, '2,1', 0, '', '', '', '', 1031);
INSERT INTO `5kcrm_admin_field` VALUES (100, 'crm_customer', 0, 'email', '邮箱', 'email', '', 0, 0, 0, '', '', 7, 191, 1553788800, 1769506169, 14, '', 0, 50, '3,0', 0, '', '', '', '', 1032);
...
INSERT INTO `5kcrm_admin_field` VALUES (119, 'crm_customer', 0, 'crm_knbnfs', '客户简称', 'text', '', 0, 0, 0, '', NULL, 9, 255, 1769506168, 1769506168, 1, NULL, 0, 25, '4,0', NULL, NULL, NULL, NULL, NULL, 1033);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限管理-字段授权' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `5kcrm_admin_file` VALUES (1, 'file', 'app.png', '20260125/01a3a07c6450fbb8b4b82e0231acba9f.png', 7864, 1, 1769309077, '.\\public\\uploads\\20260125/01a3a07c6450fbb8b4b82e0231acba9f.png', '.\\public\\uploads\\20260125/thumb_01a3a07c6450fbb8b4b82e0231acba9f.png');
INSERT INTO `5kcrm_admin_file` VALUES (2, 'file', 'app.png', '20260125/6c9d254661d65d7a268733964e18942e.png', 7864, 1, 1769311326, '.\\public\\uploads\\20260125/6c9d254661d65d7a268733964e18942e.png', '.\\public\\uploads\\20260125/thumb_6c9d254661d65d7a268733964e18942e.png');
...
-- ----------------------------
INSERT INTO `5kcrm_admin_login_record` VALUES (1, 0, 1, 1769153730, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (2, 0, 1, 1769155090, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (3, 0, 1, 1769158901, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (4, 0, 1, 1769159281, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (5, 0, 1, 1769162414, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (6, 0, 1, 1769162885, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (7, 0, 1, 1769168158, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (8, 0, 1, 1769169124, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (9, 0, 1, 1769222341, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (10, 0, 1, 1769247210, '192.168.10.15', '局域网', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (11, 0, 1, 1769261626, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (12, 0, 1, 1769263329, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (13, 0, 1, 1769306227, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (14, 0, 1, 1769306315, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (15, 0, 1, 1769306737, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (16, 0, 1, 1769306762, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (17, 0, 1, 1769322162, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (18, 0, 1, 1769474455, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
INSERT INTO `5kcrm_admin_login_record` VALUES (19, 0, 1, 1769499016, '127.0.0.1', '本机地址', 'Chrome', 'Windows 10', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统设置 活动表单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_admin_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台菜单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_admin_menu` VALUES (10, 1, '鏀舵敮绠＄悊', '', '', 0, 0, 1, 240, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (11, 10, '鏀舵敮绫诲瀷', '', '', 0, 0, 1, 241, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (12, 10, '娴佹按', '', '', 0, 0, 1, 242, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (13, 10, '璁″垝', '', '', 0, 0, 1, 243, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (14, 1, '鏀舵敮绠＄悊', '', '', 0, 0, 1, 258, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (15, 14, '鏀舵敮绫诲瀷', '', '', 0, 0, 1, 259, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (16, 14, '娴佹按', '', '', 0, 0, 1, 260, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (17, 14, '璁″垝', '', '', 0, 0, 1, 261, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (18, 1, '客户台账', '', '', 0, 0, 1, 276, 'ledger');
INSERT INTO `5kcrm_admin_menu` VALUES (19, 1, '收支管理', '', '', 0, 0, 1, 283, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (20, 19, '收支类型', '', '', 0, 0, 1, 284, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (21, 19, '流水', '', '', 0, 0, 1, 285, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (22, 19, '计划', '', '', 0, 0, 1, 286, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (23, 1, '客户台账', '', '', 0, 0, 1, 301, 'ledger');
INSERT INTO `5kcrm_admin_menu` VALUES (24, 1, '收支管理', '', '', 0, 0, 1, 311, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (25, 24, '收支类型', '', '', 0, 0, 1, 312, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (26, 24, '流水', '', '', 0, 0, 1, 313, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (27, 24, '计划', '', '', 0, 0, 1, 314, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (28, 1, '收支管理', '', '', 0, 0, 1, 329, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (29, 28, '收支类型', '', '', 0, 0, 1, 330, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (30, 28, '流水', '', '', 0, 0, 1, 331, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (31, 28, '计划', '', '', 0, 0, 1, 332, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (32, 1, '客户台账', '', '', 0, 0, 1, 347, 'ledger');
INSERT INTO `5kcrm_admin_menu` VALUES (33, 1, '收支管理', '', '', 0, 0, 1, 357, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (34, 33, '收支类型', '', '', 0, 0, 1, 358, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (35, 33, '流水', '', '', 0, 0, 1, 359, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (36, 33, '计划', '', '', 0, 0, 1, 360, 'finance');
INSERT INTO `5kcrm_admin_menu` VALUES (37, 1, '客户台账', '', '', 0, 0, 1, 375, 'ledger');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '站内信' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_admin_message
-- ----------------------------
INSERT INTO `5kcrm_admin_message` VALUES (1, 11, 1, 1, '管理员 提交 定制合同 合同审批待您处理，请及时查看。', 1769309948, 1769323024, 'crm', 'contract', 'save', 1, '0', 1, '定制合同');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日程自定义类型' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_admin_oa_schedule` VALUES (8, '客户台账', 1769160170, 1769160170, '8', 1, 1);
INSERT INTO `5kcrm_admin_oa_schedule` VALUES (9, '台账', 1769237487, 1769237487, '8', 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日程自定义类型显示状态' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_admin_oa_schedule_relation
-- ----------------------------
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (1, 1, 1769154114, NULL, 1, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (2, 1, 1769154114, NULL, 2, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (3, 1, 1769154114, NULL, 3, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (4, 1, 1769154114, NULL, 4, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (5, 1, 1769154114, NULL, 5, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (6, 1, 1769154114, NULL, 6, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (7, 1, 1769154114, NULL, 7, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (8, 1, 1769160170, NULL, 8, 1);
INSERT INTO `5kcrm_admin_oa_schedule_relation` VALUES (9, 0, 1769237488, NULL, 9, 1);
...
INSERT INTO `5kcrm_admin_oalog_rule` VALUES (2, 1, '3,4,10', '', '08:00', '21:00', 0, NULL);
INSERT INTO `5kcrm_admin_oalog_rule` VALUES (3, 2, '3,4', NULL, '1', '3', 0, NULL);
INSERT INTO `5kcrm_admin_oalog_rule` VALUES (4, 3, '3', NULL, '3', '8', 0, NULL);
...
CREATE TABLE `5kcrm_admin_operation_log`  (
  ...
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_admin_operation_log
-- ----------------------------
INSERT INTO `5kcrm_admin_operation_log` VALUES (1, '山东文汇', 1, '192.168.10.15', 'crm_customer', 1, '新增了客户山东文汇', 1769157616, 'save');
INSERT INTO `5kcrm_admin_operation_log` VALUES (2, '山东文汇', 1, '192.168.10.15', 'crm_customer', 1, '修改客户:山东文汇成交状态:已成交', 1769176961, 'status');
INSERT INTO `5kcrm_admin_operation_log` VALUES (3, '赵晓红', 1, '127.0.0.1', 'crm_contacts', 1, '新增了联系人赵晓红', 1769309931, 'save');
INSERT INTO `5kcrm_admin_operation_log` VALUES (4, '定制合同', 1, '127.0.0.1', 'crm_contract', 1, '新增了合同定制合同', 1769309948, 'save');
INSERT INTO `5kcrm_admin_operation_log` VALUES (5, '山东云算软件', 1, '127.0.0.1', 'crm_customer', 1, '新增了客户山东云算软件', 1769318003, 'save');
INSERT INTO `5kcrm_admin_operation_log` VALUES (6, '山东文汇', 1, '127.0.0.1', 'crm_customer', 1, '将 \'客户简称\' 由 空 修改为 文汇', 1769506200, 'update');
...
CREATE TABLE `5kcrm_admin_rule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 385 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限规则表' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_admin_rule` VALUES (240, 2, '鏀舵敮绠＄悊', 'finance', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (241, 2, '鏀舵敮绫诲瀷', 'type', 2, 240, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (242, 2, '娴佹按', 'record', 2, 240, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (243, 2, '璁″垝', 'plan', 2, 240, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (244, 2, '鏂板缓', 'save', 3, 241, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (245, 2, '缂栬緫', 'update', 3, 241, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (246, 2, '鏌ョ湅鍒楄〃', 'index', 3, 241, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (247, 2, '鍒犻櫎', 'delete', 3, 241, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (248, 2, '鏂板缓', 'save', 3, 242, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (249, 2, '缂栬緫', 'update', 3, 242, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (250, 2, '鏌ョ湅鍒楄〃', 'index', 3, 242, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (251, 2, '鏌ョ湅璇︽儏', 'read', 3, 242, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (252, 2, '鍒犻櫎', 'delete', 3, 242, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (253, 2, '鏂板缓', 'save', 3, 243, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (254, 2, '缂栬緫', 'update', 3, 243, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (255, 2, '鏌ョ湅鍒楄〃', 'index', 3, 243, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (256, 2, '鏌ョ湅璇︽儏', 'read', 3, 243, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (257, 2, '鍒犻櫎', 'delete', 3, 243, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (258, 2, '鏀舵敮绠＄悊', 'finance', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (259, 2, '鏀舵敮绫诲瀷', 'type', 2, 258, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (260, 2, '娴佹按', 'record', 2, 258, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (261, 2, '璁″垝', 'plan', 2, 258, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (262, 2, '鏂板缓', 'save', 3, 259, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (263, 2, '缂栬緫', 'update', 3, 259, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (264, 2, '鏌ョ湅鍒楄〃', 'index', 3, 259, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (265, 2, '鍒犻櫎', 'delete', 3, 259, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (266, 2, '鏂板缓', 'save', 3, 260, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (267, 2, '缂栬緫', 'update', 3, 260, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (268, 2, '鏌ョ湅鍒楄〃', 'index', 3, 260, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (269, 2, '鏌ョ湅璇︽儏', 'read', 3, 260, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (270, 2, '鍒犻櫎', 'delete', 3, 260, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (271, 2, '鏂板缓', 'save', 3, 261, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (272, 2, '缂栬緫', 'update', 3, 261, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (273, 2, '鏌ョ湅鍒楄〃', 'index', 3, 261, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (274, 2, '鏌ョ湅璇︽儏', 'read', 3, 261, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (275, 2, '鍒犻櫎', 'delete', 3, 261, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (276, 2, '客户台账', 'ledger', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (277, 2, '客户台账', 'ledger', 2, 276, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (278, 2, '新建', 'save', 3, 277, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (279, 2, '编辑', 'update', 3, 277, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (280, 2, '查看列表', 'index', 3, 277, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (281, 2, '查看详情', 'read', 3, 277, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (282, 2, '删除', 'delete', 3, 277, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (283, 2, '收支管理', 'finance', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (284, 2, '收支类型', 'type', 2, 283, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (285, 2, '流水', 'record', 2, 283, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (286, 2, '计划', 'plan', 2, 283, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (287, 2, '新建', 'save', 3, 284, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (288, 2, '编辑', 'update', 3, 284, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (289, 2, '查看列表', 'index', 3, 284, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (290, 2, '删除', 'delete', 3, 284, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (291, 2, '新建', 'save', 3, 285, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (292, 2, '编辑', 'update', 3, 285, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (293, 2, '查看列表', 'index', 3, 285, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (294, 2, '查看详情', 'read', 3, 285, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (295, 2, '删除', 'delete', 3, 285, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (296, 2, '新建', 'save', 3, 286, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (297, 2, '编辑', 'update', 3, 286, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (298, 2, '查看列表', 'index', 3, 286, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (299, 2, '查看详情', 'read', 3, 286, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (300, 2, '删除', 'delete', 3, 286, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (301, 2, '客户台账', 'ledger', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (302, 2, '客户台账', 'ledger', 2, 301, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (303, 2, '创建', 'save', 3, 302, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (304, 2, '编辑', 'update', 3, 302, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (305, 2, '查看列表', 'index', 3, 302, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (306, 2, '查看详情', 'read', 3, 302, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (307, 2, '删除', 'delete', 3, 302, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (308, 2, '进度记录', 'record', 2, 301, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (309, 2, '查看', 'list', 3, 308, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (310, 2, '新增记录', 'add', 3, 308, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (311, 2, '收支管理', 'finance', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (312, 2, '收支类型', 'type', 2, 311, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (313, 2, '流水', 'record', 2, 311, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (314, 2, '计划', 'plan', 2, 311, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (315, 2, '新建', 'save', 3, 312, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (316, 2, '编辑', 'update', 3, 312, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (317, 2, '查看列表', 'index', 3, 312, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (318, 2, '删除', 'delete', 3, 312, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (319, 2, '新建', 'save', 3, 313, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (320, 2, '编辑', 'update', 3, 313, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (321, 2, '查看列表', 'index', 3, 313, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (322, 2, '查看详情', 'read', 3, 313, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (323, 2, '删除', 'delete', 3, 313, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (324, 2, '新建', 'save', 3, 314, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (325, 2, '编辑', 'update', 3, 314, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (326, 2, '查看列表', 'index', 3, 314, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (327, 2, '查看详情', 'read', 3, 314, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (328, 2, '删除', 'delete', 3, 314, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (329, 2, '收支管理', 'finance', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (330, 2, '收支类型', 'type', 2, 329, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (331, 2, '流水', 'record', 2, 329, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (332, 2, '计划', 'plan', 2, 329, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (333, 2, '新建', 'save', 3, 330, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (334, 2, '编辑', 'update', 3, 330, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (335, 2, '查看列表', 'index', 3, 330, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (336, 2, '删除', 'delete', 3, 330, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (337, 2, '新建', 'save', 3, 331, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (338, 2, '编辑', 'update', 3, 331, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (339, 2, '查看列表', 'index', 3, 331, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (340, 2, '查看详情', 'read', 3, 331, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (341, 2, '删除', 'delete', 3, 331, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (342, 2, '新建', 'save', 3, 332, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (343, 2, '编辑', 'update', 3, 332, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (344, 2, '查看列表', 'index', 3, 332, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (345, 2, '查看详情', 'read', 3, 332, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (346, 2, '删除', 'delete', 3, 332, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (347, 2, '客户台账', 'ledger', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (348, 2, '客户台账', 'ledger', 2, 347, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (349, 2, '创建', 'save', 3, 348, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (350, 2, '编辑', 'update', 3, 348, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (351, 2, '查看列表', 'index', 3, 348, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (352, 2, '查看详情', 'read', 3, 348, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (353, 2, '删除', 'delete', 3, 348, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (354, 2, '进度记录', 'record', 2, 347, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (355, 2, '查看', 'list', 3, 354, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (356, 2, '新增记录', 'add', 3, 354, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (357, 2, '收支管理', 'finance', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (358, 2, '收支类型', 'type', 2, 357, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (359, 2, '流水', 'record', 2, 357, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (360, 2, '计划', 'plan', 2, 357, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (361, 2, '新建', 'save', 3, 358, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (362, 2, '编辑', 'update', 3, 358, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (363, 2, '查看列表', 'index', 3, 358, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (364, 2, '删除', 'delete', 3, 358, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (365, 2, '新建', 'save', 3, 359, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (366, 2, '编辑', 'update', 3, 359, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (367, 2, '查看列表', 'index', 3, 359, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (368, 2, '查看详情', 'read', 3, 359, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (369, 2, '删除', 'delete', 3, 359, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (370, 2, '新建', 'save', 3, 360, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (371, 2, '编辑', 'update', 3, 360, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (372, 2, '查看列表', 'index', 3, 360, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (373, 2, '查看详情', 'read', 3, 360, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (374, 2, '删除', 'delete', 3, 360, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (375, 2, '客户台账', 'ledger', 1, 0, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (376, 2, '客户台账', 'ledger', 2, 375, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (377, 2, '创建', 'save', 3, 376, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (378, 2, '编辑', 'update', 3, 376, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (379, 2, '查看列表', 'index', 3, 376, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (380, 2, '查看详情', 'read', 3, 376, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (381, 2, '删除', 'delete', 3, 376, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (382, 2, '进度记录', 'record', 2, 375, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (383, 2, '查看', 'list', 3, 382, 1);
INSERT INTO `5kcrm_admin_rule` VALUES (384, 2, '新增记录', 'add', 3, 382, 1);
...
-- ----------------------------
INSERT INTO `5kcrm_admin_system` VALUES (1, 'name', 'CRM', '网站名称');
...
CREATE TABLE `5kcrm_admin_system_log`  (
  ...
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_admin_system_log
-- ----------------------------
INSERT INTO `5kcrm_admin_system_log` VALUES (1, '日志规则', 1, '127.0.0.1', 'work_task', 'admin_oalog_rule', 'update', 1, 0, '设置了日志规则', 1769501716);
INSERT INTO `5kcrm_admin_system_log` VALUES (2, '日志规则', 1, '127.0.0.1', 'work_task', 'admin_oalog_rule', 'update', 1, 0, '设置了日志规则', 1769501721);
INSERT INTO `5kcrm_admin_system_log` VALUES (3, '客户', 1, '127.0.0.1', 'customer', 'crm_customer', 'update', 1, 0, '编辑了自定义字段：客户', 1769506169);
INSERT INTO `5kcrm_admin_system_log` VALUES (4, '企业基本信息设置', 1, '127.0.0.1', 'company', 'admin_system', 'update', 1, 0, '编辑了：企业logo', 1769511755);
INSERT INTO `5kcrm_admin_system_log` VALUES (5, '企业基本信息设置', 1, '127.0.0.1', 'company', 'admin_system', 'update', 1, 0, '编辑了：企业名称', 1769511755);
...
-- ----------------------------
INSERT INTO `5kcrm_admin_user` VALUES (1, '15628812133', '21ae9f2f844e6bd7b5784d3df7244b1d', 'faa5', '', '', 1769144963, '管理员', '', '', '15628812133', '', 1, 'CEO', 1, 0, '494b8022c7c3819cae41b024b30aadf7', 1772091016, 1, 1);
...
-- ----------------------------
DROP TABLE IF EXISTS `5kcrm_app_navigation`;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '手机端导航数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_crm_achievement`  (
  ...
  `january` decimal(18, 2) NOT NULL COMMENT '一月',
  `february` decimal(18, 2) NOT NULL COMMENT '二月',
  `march` decimal(18, 2) NOT NULL COMMENT '三月',
  `april` decimal(18, 2) NOT NULL COMMENT '四月',
  `may` decimal(18, 2) NOT NULL COMMENT '五月',
  `june` decimal(18, 2) NOT NULL COMMENT '六月',
  `july` decimal(18, 2) NOT NULL COMMENT '七月',
  `august` decimal(18, 2) NOT NULL COMMENT '八月',
  `september` decimal(18, 2) NOT NULL COMMENT '九月',
  `october` decimal(18, 2) NOT NULL COMMENT '十月',
  `november` decimal(18, 2) NOT NULL COMMENT '十一月',
  `december` decimal(18, 2) NOT NULL COMMENT '十二月',
  `status` tinyint(2) NOT NULL DEFAULT 0 COMMENT '1销售（目标）2回款（目标）',
  `yeartarget` decimal(18, 2) NOT NULL COMMENT '年目标',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '跟进记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_crm_activity
-- ----------------------------
INSERT INTO `5kcrm_crm_activity` VALUES (1, NULL, 1, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL, 2, '山东文汇', '', 0, '', '', 1769157616, 1769157616, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (2, NULL, 8, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '创建台账', '台账', 0, '', '', 1769169144, 1769169144, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (3, NULL, 8, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '3123', '台账', 0, '', '', 1769169319, 1769169319, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (4, NULL, 7, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '1111', '台账', 0, '', '', 1769171337, 1769171337, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (5, NULL, 7, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '32133', '台账', 0, '', '', 1769171344, 1769171344, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (6, NULL, 9, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '创建台账', '台账', 0, '', '', 1769171364, 1769171364, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (7, NULL, 10, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '创建台账', '台账', 0, '', '', 1769233010, 1769233010, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (8, NULL, 1, 2, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 3, '赵晓红', '', 0, '', '', 1769309931, 1769309931, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (9, NULL, 1, 2, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 6, '定制合同', '', 0, ',,', ',,', 1769309948, 1769309948, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (10, NULL, 9, 1, 1, NULL, NULL, NULL, ',1,', '', NULL, 14, '创建了支出记录：差旅费，金额：1,500.00元', '收支', 0, '', '', 1769315698, 1769315698, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (11, NULL, 2, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL, 2, '山东云算软件', '', 0, '', '', 1769318003, 1769318003, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (12, NULL, 10, 1, 1, NULL, NULL, NULL, ',2,', '', NULL, 14, '创建了支出记录：差旅费，金额：4,500.00元', '收支', 0, '', '', 1769318045, 1769318045, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (13, NULL, 11, 1, 1, NULL, NULL, NULL, ',2,', '', NULL, 14, '创建了收入记录：服务运维费，金额：4,500.00元', '收支', 0, '', '', 1769323074, 1769323074, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (14, NULL, 12, 1, 1, NULL, NULL, NULL, '', '', NULL, 14, '创建了支出记录：员工工资，金额：1,222.00元', '收支', 0, '', '', 1769327043, 1769327043, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (15, NULL, 13, 1, 1, NULL, NULL, NULL, ',1,', '', NULL, 14, '创建了支出记录：员工工资，金额：3.00元', '收支', 0, '', '', 1769474483, 1769474483, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (16, NULL, 14, 1, 1, NULL, NULL, NULL, ',2,', '', NULL, 14, '创建了支出记录：社保公积金，金额：1,220.00元', '收支', 0, '', '', 1769475805, 1769475805, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (17, NULL, 11, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '创建台账', '台账', 0, '', '', 1769508048, 1769508048, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (18, NULL, 11, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '已经跟进', '台账', 0, '', '', 1769508083, 1769508083, 1);
INSERT INTO `5kcrm_crm_activity` VALUES (19, NULL, 12, 1, 1, NULL, NULL, NULL, ',1,', NULL, NULL, 13, '创建台账', '台账', 0, '', '', 1769511714, 1769511714, 1);
...
CREATE TABLE `5kcrm_crm_business`  (
  ...
  `total_price` decimal(18, 2) NOT NULL COMMENT '产品总金额',
  `deal_date` date NULL DEFAULT NULL COMMENT '预计成交日期',
  `discount_rate` decimal(10, 2) NOT NULL COMMENT '整单折扣',
...
CREATE TABLE `5kcrm_crm_business_data`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商机表扩展字段数据' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_crm_config` VALUES (12, 'ledger_category', '[\"\\u4f7f\\u7528\\u6307\\u5bfc\",\"\\u64cd\\u4f5c\\u9519\\u8bef\",\"\\u529f\\u80fd\\u5b8c\\u5584\",\"\\u7cfb\\u7edfBUG\",\"\\u65b0\\u589e\\u9700\\u6c42\",\"\\u5176\\u4ed6\\u95ee\\u9898\"]', '台账问题分类');
...
-- ----------------------------
INSERT INTO `5kcrm_crm_contacts` VALUES (1, '1', '赵晓红', '', '', '', '', '', '', '', '', '', '', 1, 1, 0, 1, 1769309931, 1769309931, NULL, NULL);
...
CREATE TABLE `5kcrm_crm_contacts_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '联系人表扩展字段数据' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `5kcrm_crm_contract` VALUES (1, '1', '', '', '定制合同', 'HT-20260125-1', '2026-01-25', 2550.00, 0.00, 0.00, 2, 11, 0, '', ',1,', '2026-01-25', '2026-01-31', '', '', 1, 1, '', '', 0, 1769309948, 1769309955, 1, 1, NULL, NULL);
...
CREATE TABLE `5kcrm_crm_contract_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '合同表扩展字段数据' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_crm_customer`  (
  ...
  `crm_knbnfs` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客户简称',
...
-- ----------------------------
INSERT INTO `5kcrm_crm_customer` VALUES (1, '山东文汇', 0, 1769309955, 'B（普通客户）', 'IT/通信/电子/互联网', '转介绍', '1', '', '', '', 1, 1, '', '', '', '', '', NULL, NULL, 0, NULL, 1769157616, 1769157616, 1769506200, 1, 0, NULL, NULL, '', 0, 0, 0, '已成交', '文汇');
INSERT INTO `5kcrm_crm_customer` VALUES (2, '山东云算软件', 0, 1769318003, 'B（普通客户）', '贸易', '转介绍', '', '', '', '', 1, 1, '', '', '', '', '', NULL, NULL, 0, NULL, 1769318003, 1769318003, 1769318003, 1, 0, NULL, NULL, '', 0, 0, 0, '未成交', NULL);
...
CREATE TABLE `5kcrm_crm_customer_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户表扩展字段数据' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公海字段表' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_crm_customer_pool_field_setting` VALUES (42, 1, '客户简称', 'crm_knbnfs', 'text', 1, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '待办事项关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_crm_dealt_relation
-- ----------------------------
INSERT INTO `5kcrm_crm_dealt_relation` VALUES (1, 'crm_contract', 1, 1);
...
CREATE TABLE `5kcrm_crm_invoice`  (
  ...
  `invoice_money` decimal(18, 2) NULL COMMENT '开票金额',
  ...
  `contract_money` decimal(18, 2) NULL COMMENT '合同金额',
...
CREATE TABLE `5kcrm_crm_invoice_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '发票表扩展字段数据' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_crm_leads_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '线索表扩展字段数据' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_crm_number_sequence` VALUES (3, 3, 3, '1', 1, 1, 2, 1769309948, 1624437606, 1, NULL, 0, 1);
...
CREATE TABLE `5kcrm_crm_product`  (
  ...
  `price` decimal(18, 2) NULL COMMENT '标准价格',
...
CREATE TABLE `5kcrm_crm_product_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品表扩展字段数据' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_crm_receivables_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '回款表扩展字段数据' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_crm_receivables_plan`  (
  ...
  `real_money` decimal(18, 2) NOT NULL COMMENT '实际回款金额',
  `real_data` date NULL DEFAULT NULL COMMENT '实际回款日期',
  `un_money` decimal(18, 2) NOT NULL COMMENT '未回金额',
...
CREATE TABLE `5kcrm_crm_receivables_plan_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '回款计划表扩展字段数据' ROW_FORMAT = Dynamic;
...
CREATE TABLE `5kcrm_crm_visit_data`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '字段内容',
  `create_time` int(10) UNSIGNED NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '回访表扩展字段数据' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for 5kcrm_customer_ledger
-- ----------------------------
DROP TABLE IF EXISTS `5kcrm_customer_ledger`;
CREATE TABLE `5kcrm_customer_ledger`  (
  `ledger_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL DEFAULT 0 COMMENT '客户ID',
  `business_id` int(11) NOT NULL DEFAULT 0 COMMENT '商机ID',
  `contract_id` int(11) NOT NULL DEFAULT 0 COMMENT '合同ID',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '反馈问题',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '问题描述',
  `feedback_user` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '反馈人',
  `category` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '问题分类',
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '处理状态',
  `register_time` int(11) NOT NULL DEFAULT 0 COMMENT '登记时间',
  `finish_time` int(11) NOT NULL DEFAULT 0 COMMENT '处理完成时间',
  `register_user_id` int(11) NOT NULL DEFAULT 0 COMMENT '登记人',
  `handler_user_id` int(11) NOT NULL DEFAULT 0 COMMENT '处理人',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `update_time` int(11) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`ledger_id`) USING BTREE,
  INDEX `idx_ledger_customer`(`customer_id`) USING BTREE,
  INDEX `idx_ledger_status`(`status`) USING BTREE,
  INDEX `idx_ledger_category`(`category`) USING BTREE,
  INDEX `idx_ledger_business`(`business_id`) USING BTREE,
  INDEX `idx_ledger_contract`(`contract_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户台账' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_customer_ledger
-- ----------------------------
INSERT INTO `5kcrm_customer_ledger` VALUES (1, 1, 0, 0, '1', '1', '11', 'BUG', '处理中', 1769157651, 1769157653, 1, 2, '', 1769157655, 1769157655);
INSERT INTO `5kcrm_customer_ledger` VALUES (2, 1, 0, 0, '123123', '3123312', '', '其他', '待处理', 1769158384, 0, 1, 1, '', 1769158384, 1769158912);
INSERT INTO `5kcrm_customer_ledger` VALUES (3, 1, 0, 0, 'ipad中', '3213', '3213', 'BUG', '处理中', 1769163043, 0, 1, 1, '', 1769163043, 1769163043);
INSERT INTO `5kcrm_customer_ledger` VALUES (4, 1, 0, 0, '123', '3213', '321', 'BUG', '待处理', 1769168714, 0, 1, 1, '3213123', 1769168714, 1769168714);
INSERT INTO `5kcrm_customer_ledger` VALUES (5, 1, 0, 0, '123', '3213', '321', 'BUG', '待处理', 1769168732, 0, 1, 1, '3213123', 1769168732, 1769168732);
INSERT INTO `5kcrm_customer_ledger` VALUES (6, 1, 0, 0, '3123', '321', '312', '操作指导', '待处理', 1769168997, 0, 1, 1, '3123', 1769168997, 1769168997);
INSERT INTO `5kcrm_customer_ledger` VALUES (7, 1, 0, 0, '3123', '321', '312', '操作指导', '待验证', 1769169005, 0, 1, 1, '3123', 1769169005, 1769171344);
INSERT INTO `5kcrm_customer_ledger` VALUES (8, 1, 0, 0, '312', '3123', '321', '其他', '待验证', 1769169144, 0, 1, 1, '', 1769169144, 1769169144);
INSERT INTO `5kcrm_customer_ledger` VALUES (9, 1, 0, 0, '标题', '内容', '手术室', '其他', '处理中', 1769171364, 0, 1, 0, '', 1769171364, 1769171364);
INSERT INTO `5kcrm_customer_ledger` VALUES (10, 1, 0, 0, '3123', '312', '3123', 'BUG', '处理中', 1769233010, 0, 1, 0, '', 1769233010, 1769233010);
INSERT INTO `5kcrm_customer_ledger` VALUES (11, 1, 0, 0, '文图我反馈', '无法访问app', '山东文汇', '新需求', '待处理', 1769508048, 0, 1, 1, '', 1769508048, 1769508048);
INSERT INTO `5kcrm_customer_ledger` VALUES (12, 1, 0, 0, '平板打不开了', 'ippd无法打开', '', '其他', '待处理', 1769511714, 0, 1, 0, '', 1769511714, 1769511714);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '台账进度记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `5kcrm_customer_ledger_record` VALUES (7, 11, 1, '创建台账', '', '待处理', 1, 1769508048);
INSERT INTO `5kcrm_customer_ledger_record` VALUES (8, 11, 1, '已经跟进', '待处理', '待处理', 1, 1769508083);
INSERT INTO `5kcrm_customer_ledger_record` VALUES (9, 12, 1, '创建台账', '', '待处理', 1, 1769511714);

-- ----------------------------
-- Table structure for 5kcrm_finance_payment_method
-- ----------------------------
DROP TABLE IF EXISTS `5kcrm_finance_payment_method`;
CREATE TABLE `5kcrm_finance_payment_method`  (
  `method_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '支付方式ID',
...
-- ----------------------------
-- Records of 5kcrm_finance_payment_method
-- ----------------------------
INSERT INTO `5kcrm_finance_payment_method` VALUES (1, '企业公户', 1, 1, 1, 1769312095, 1769312095);
INSERT INTO `5kcrm_finance_payment_method` VALUES (2, '企业一般户', 1, 2, 1, 1769312095, 1769312095);
INSERT INTO `5kcrm_finance_payment_method` VALUES (3, '企业支付宝', 1, 3, 1, 1769312095, 1769312095);
INSERT INTO `5kcrm_finance_payment_method` VALUES (4, '个人支付宝', 1, 4, 1, 1769312095, 1769312095);
INSERT INTO `5kcrm_finance_payment_method` VALUES (5, '企业微信', 1, 5, 1, 1769312095, 1769312095);
INSERT INTO `5kcrm_finance_payment_method` VALUES (6, '个人微信', 1, 6, 1, 1769312095, 1769312095);
INSERT INTO `5kcrm_finance_payment_method` VALUES (7, '备用金', 1, 7, 1, 1769312095, 1769312095);

-- ----------------------------
-- Table structure for 5kcrm_finance_plan
-- ----------------------------
DROP TABLE IF EXISTS `5kcrm_finance_plan`;
CREATE TABLE `5kcrm_finance_plan`  (
  `plan_id` int(11) NOT NULL AUTO_INCREMENT,
  `direction` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'income/expense',
  `customer_id` int(11) NOT NULL DEFAULT 0 COMMENT '瀹㈡埛ID',
  `contract_id` int(11) NOT NULL DEFAULT 0 COMMENT '鍚堝悓ID',
  `type_id` int(11) NOT NULL DEFAULT 0 COMMENT '绫诲瀷ID',
  `plan_amount` decimal(18, 2) NOT NULL COMMENT '璁″垝閲戦?',
  `plan_date` date NULL DEFAULT NULL COMMENT '璁″垝鏃ユ湡',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0鏈?彂鐢?1閮ㄥ垎瀹屾垚 2宸插畬鎴',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '澶囨敞',
  `create_user_id` int(11) NOT NULL DEFAULT 0 COMMENT '鍒涘缓浜',
  `create_time` int(11) NOT NULL COMMENT '鍒涘缓鏃堕棿',
  `update_time` int(11) NOT NULL COMMENT '鏇存柊鏃堕棿',
  `business_id` int(11) NOT NULL DEFAULT 0 COMMENT '商机ID',
  `rel_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'none' COMMENT '关联类型: none/customer/contract/business',
  PRIMARY KEY (`plan_id`) USING BTREE,
  INDEX `idx_finance_plan_type`(`type_id`) USING BTREE,
  INDEX `idx_finance_plan_customer`(`customer_id`) USING BTREE,
  INDEX `idx_finance_plan_contract`(`contract_id`) USING BTREE,
  INDEX `idx_finance_plan_business`(`business_id`) USING BTREE,
  INDEX `idx_finance_plan_rel_type`(`rel_type`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '鏀舵敮璁″垝' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_finance_plan
-- ----------------------------

-- ----------------------------
-- Table structure for 5kcrm_finance_record
-- ----------------------------
DROP TABLE IF EXISTS `5kcrm_finance_record`;
CREATE TABLE `5kcrm_finance_record`  (
  `record_id` int(11) NOT NULL AUTO_INCREMENT,
  `direction` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'income/expense',
  `customer_id` int(11) NOT NULL DEFAULT 0 COMMENT '瀹㈡埛ID',
  `contract_id` int(11) NOT NULL DEFAULT 0 COMMENT '鍚堝悓ID',
  `type_id` int(11) NOT NULL DEFAULT 0 COMMENT '绫诲瀷ID',
  `amount` decimal(18, 2) NOT NULL COMMENT '閲戦?',
  `occur_date` date NOT NULL COMMENT '鍙戠敓鏃ユ湡',
  `handler_user_id` int(11) NOT NULL DEFAULT 0 COMMENT '缁忓姙浜',
  `payment_method_id` int(11) NOT NULL DEFAULT 0 COMMENT '支付方式ID',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '澶囨敞',
  `voucher` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '支付凭证（图片URL或文件路径）',
  `plan_id` int(11) NOT NULL DEFAULT 0 COMMENT '璁″垝ID',
  `create_user_id` int(11) NOT NULL DEFAULT 0 COMMENT '鍒涘缓浜',
  `create_time` int(11) NOT NULL COMMENT '鍒涘缓鏃堕棿',
  `update_time` int(11) NOT NULL COMMENT '鏇存柊鏃堕棿',
  `business_id` int(11) NOT NULL DEFAULT 0 COMMENT '商机ID',
  `rel_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'none' COMMENT '关联类型: none/customer/contract/business',
  PRIMARY KEY (`record_id`) USING BTREE,
  INDEX `idx_finance_record_type`(`type_id`) USING BTREE,
  INDEX `idx_finance_record_customer`(`customer_id`) USING BTREE,
  INDEX `idx_finance_record_contract`(`contract_id`) USING BTREE,
  INDEX `idx_finance_record_plan`(`plan_id`) USING BTREE,
  INDEX `idx_finance_record_business`(`business_id`) USING BTREE,
  INDEX `idx_finance_record_rel_type`(`rel_type`) USING BTREE,
  INDEX `idx_payment_method`(`payment_method_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '鏀舵敮娴佹按' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_finance_record
-- ----------------------------
INSERT INTO `5kcrm_finance_record` VALUES (1, 'expense', 0, 0, 8, 3.00, '2026-01-13', 1, 0, '', '[{\"key\":0,\"name\":\"app.png\",\"status\":1,\"path\":\"http://localhost/public/uploads/20260125/6c9d254661d65d7a268733964e18942e.png\",\"save_name\":\"20260125/6c9d254661d65d7a268733964e18942e.png\",\"url\":\"http://localhost/public/uploads/20260125/6c9d254661d65d7a268733964e18942e.png\",\"size\":\"7.68KB\",\"file_id\":\"2\"}]', 0, 1, 1769308630, 1769311328, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (2, 'expense', 0, 0, 5, 4.00, '2026-01-25', 1, 0, '', '[{\"key\":0,\"name\":\"app.png\",\"status\":1,\"path\":\"http://localhost/public/uploads/20260125/01a3a07c6450fbb8b4b82e0231acba9f.png\",\"save_name\":\"20260125/01a3a07c6450fbb8b4b82e0231acba9f.png\",\"url\":\"http://localhost/public/uploads/20260125/01a3a07c6450fbb8b4b82e0231acba9f.png\",\"size\":\"7.68KB\",\"file_id\":\"1\"}]', 0, 1, 1769309090, 1769309090, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (3, 'expense', 0, 0, 5, 158000.00, '2026-01-19', 1, 0, '', '', 0, 1, 1769311341, 1769311341, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (4, 'expense', 0, 1, 16, 5.00, '2026-01-19', 1, 0, '', '', 0, 1, 1769311369, 1769311369, 0, 'contract');
INSERT INTO `5kcrm_finance_record` VALUES (5, 'expense', 0, 0, 4, 16000.00, '2026-01-22', 1, 0, '', '', 0, 1, 1769311437, 1769311437, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (6, 'income', 0, 0, 6, 48500.00, '2026-01-14', 1, 0, '', '', 0, 1, 1769311451, 1769311451, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (7, 'income', 0, 0, 5, 7500.00, '2026-01-01', 1, 0, '', '', 0, 1, 1769311617, 1769311617, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (8, 'expense', 1, 0, 19, 1500.00, '2026-01-14', 0, 0, '', '', 0, 1, 1769314255, 1769314255, 0, 'customer');
INSERT INTO `5kcrm_finance_record` VALUES (9, 'expense', 1, 0, 17, 1500.00, '2026-01-19', 1, 0, '', '', 0, 1, 1769315698, 1769315698, 0, 'customer');
INSERT INTO `5kcrm_finance_record` VALUES (10, 'expense', 2, 0, 17, 4500.00, '2026-01-26', 0, 6, '', '', 0, 1, 1769318045, 1769318045, 0, 'customer');
INSERT INTO `5kcrm_finance_record` VALUES (11, 'income', 2, 0, 8, 4500.00, '2026-01-05', 1, 4, '', '', 0, 1, 1769323074, 1769323074, 0, 'customer');
INSERT INTO `5kcrm_finance_record` VALUES (12, 'expense', 0, 0, 15, 1222.00, '2026-01-12', 0, 5, '', '', 0, 1, 1769327043, 1769327043, 0, 'none');
INSERT INTO `5kcrm_finance_record` VALUES (13, 'expense', 1, 0, 15, 3.00, '2026-01-20', 1, 0, '', '', 0, 1, 1769474483, 1769474483, 0, 'customer');
INSERT INTO `5kcrm_finance_record` VALUES (14, 'expense', 2, 0, 16, 1220.00, '2026-01-27', 0, 4, '', '', 0, 1, 1769475805, 1769475805, 0, 'customer');

-- ----------------------------
-- Table structure for 5kcrm_finance_type
-- ----------------------------
DROP TABLE IF EXISTS `5kcrm_finance_type`;
CREATE TABLE `5kcrm_finance_type`  (
  `type_id` int(11) NOT NULL AUTO_INCREMENT,
  `direction` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'income/expense',
  `parent_id` int(11) NOT NULL DEFAULT 0 COMMENT '父级分类ID，0表示顶级分类',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '绫诲瀷鍚嶇О',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1鍚?敤 0鍋滅敤',
  `sort` int(11) NOT NULL DEFAULT 0 COMMENT '鎺掑簭',
  `create_user_id` int(11) NOT NULL DEFAULT 0 COMMENT '鍒涘缓浜',
  `create_time` int(11) NOT NULL COMMENT '鍒涘缓鏃堕棿',
  `update_time` int(11) NOT NULL COMMENT '鏇存柊鏃堕棿',
  PRIMARY KEY (`type_id`) USING BTREE,
  INDEX `idx_finance_type_parent`(`parent_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '鏀舵敮绫诲瀷' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of 5kcrm_finance_type
-- ----------------------------
INSERT INTO `5kcrm_finance_type` VALUES (1, 'income', 0, '软件销售', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (2, 'income', 0, '技术服务', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (3, 'income', 0, '其他收入', 1, 99, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (4, 'income', 1, 'A软件销售', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (5, 'income', 1, 'B软件销售', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (6, 'income', 1, '软件授权费', 1, 3, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (7, 'income', 2, '产品运维费', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (8, 'income', 2, '服务运维费', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (9, 'income', 2, '技术服务费', 1, 3, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (10, 'expense', 0, '人员成本', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (11, 'expense', 0, '管理费用', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (12, 'expense', 0, '研发费用', 1, 3, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (13, 'expense', 0, '营销费用', 1, 4, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (14, 'expense', 0, '其他支出', 1, 99, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (15, 'expense', 10, '员工工资', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (16, 'expense', 10, '社保公积金', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (17, 'expense', 11, '差旅费', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (18, 'expense', 11, '办公用品', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (19, 'expense', 11, '电话费', 1, 3, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (20, 'expense', 11, '房租', 1, 4, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (21, 'expense', 11, '水电费', 1, 5, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (22, 'expense', 11, '税费', 1, 6, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (23, 'expense', 12, '研发费用', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (24, 'expense', 12, '市场推广费', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (25, 'expense', 13, '介绍费', 1, 1, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (26, 'expense', 13, '广告费', 1, 2, 1, 1769312099, 1769312099);
INSERT INTO `5kcrm_finance_type` VALUES (27, 'expense', 13, '技术服务费', 1, 3, 1, 1769312099, 1769312099);
...
INSERT INTO `5kcrm_hrm_user_det` VALUES (2, 1, 1769144963, 1, 1, 2, '15628812133', '', 0, '', 0, '', '', '0', 0, 0, 0, 1769144963, 1769144963, '', '', '', 0);
...
CREATE TABLE `5kcrm_oa_examine`  (
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `money` decimal(18, 2) NOT NULL COMMENT '差旅、报销总金额',
  `start_time` int(11) NOT NULL DEFAULT 0 COMMENT '开始时间',
  `end_time` int(11) NOT NULL DEFAULT 0 COMMENT '结束时间',
  `duration` decimal(10, 1) NOT NULL COMMENT '时长',
  `create_user_id` int(10) NOT NULL COMMENT '创建人ID',
...
CREATE TABLE `5kcrm_oa_examine_travel`  (
  ...
  `traffic` decimal(18, 2) NOT NULL COMMENT '交通费',
  `stay` decimal(18, 2) NOT NULL COMMENT '住宿费',
  `diet` decimal(18, 2) NOT NULL COMMENT '餐饮费',
  `other` decimal(18, 2) NOT NULL COMMENT '其他费用',
...
CREATE TABLE `5kcrm_oa_log`  (
  ...
  `save_receivables` decimal(18, 2) NOT NULL COMMENT '每日新增回款',
...
CREATE TABLE `field_group`  (
  ...
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Group name',
  `types` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Associated module',
  `sort` int(11) NOT NULL DEFAULT 0,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `create_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_group_types`(`types`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Custom field groups' ROW_FORMAT = Dynamic;
...
CREATE TABLE `field_option`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `field_id` int(11) UNSIGNED NOT NULL COMMENT 'fields.id',
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Option label',
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Option value',
  `sort` int(11) NOT NULL DEFAULT 0,
  `create_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_field_option_field`(`field_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Custom field options (select/checklist)' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of field_option
-- ----------------------------
...
CREATE TABLE `fields`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `types` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Module key (crm_customer, finance_record, etc.)',
  `field` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Field identifier',
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Display label',
  `form_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'Input type (text, select, etc.)',
  `default_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Default value',
  `options` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'Comma/line separated select options (JSON when needed)',
  `is_required` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1=required',
  `is_unique` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1=must be unique',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1=enabled',
  `sort` int(11) NOT NULL DEFAULT 0 COMMENT 'Sorting weight',
  `create_time` int(11) NOT NULL DEFAULT 0,
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uniq_types_field`(`types`, `field`) USING BTREE,
  INDEX `idx_types`(`types`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Custom field definitions' ROW_FORMAT = Dynamic;
