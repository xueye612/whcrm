...
import LedgerCategory from './components/LedgerCategory'
import DingTalkTaskNotify from './components/DingTalkTaskNotify'
  ...
  data() {
    return {
      menuList: [
        ...
        { label: '收支分类设置', key: 'FinanceType' },
        { label: '支付方式设置', key: 'PaymentMethod' },
        { label: '台账问题分类', key: 'LedgerCategory' },
        { label: '钉钉任务通知', key: 'DingTalkTaskNotify' }
      ],
