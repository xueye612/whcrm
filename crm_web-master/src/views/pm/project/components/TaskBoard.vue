        ...
        <flexbox
          ...
          <div class="board-column-header">
            <div>
              ...
              <el-popover
                v-if="showMoreBtn && item.class_id != -1"
                ...
                <div class="omit-popover-box">
                  ...
                  <p
                    ...
                    @click="createSubTaskClick(item,index)">新建任务</p>
                  <p
            ...
            <div
              ...
              <div class="img-group">
                ...
                <div
                  ...
                  <span>{{ element.childWCCount||element.subdonecount }}/{{ element.childAllCount ||(element.subdonecount+element.subcount) }}</span>
                </div>
                <div
                    ...
                    <div
                      ...
                      <div
                        ...
                        <span
                          ...
                          class="k-name"
                          style="border-radius: 4px; color: #FFF; padding: 3px 10px;">{{ k.name }}</span>
                      </div>
                    </div>
