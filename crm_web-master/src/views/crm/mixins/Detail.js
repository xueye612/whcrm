...
import { crmInvoiceNumAPI } from '@/api/crm/invoice'
    ...
    pageChange(type) {
      if (type === 'left') {
        if (this.pageIndex > 0) {
          ...
          this.$emit('update:id', this.pageList[pageIndex][`${this.crmType}_id`])
        } else {
