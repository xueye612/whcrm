...
export default {
  ...
  data() {
    return {
      briefList: [
        { label: '新增客户(人)', title: '新增客户', type: 'customer', labelValue: 2, field: 'customerNum', icon: 'wk-customer', num: '', rate: '', status: '', color: '#2362FB' },
        { label: '新增联系人(人)', title: '新增联系人', type: 'contacts', labelValue: 3, field: 'contactsNum', icon: 'wk-contacts', num: '', rate: '', status: '', color: '#27BA4A' },
        { label: '新增商机(个)', title: '新增商机', type: 'business', labelValue: 5, field: 'businessNum', icon: 'wk-business', num: '', rate: '', status: '', color: '#FB9323' },
        { label: '新增合同(个)', title: '新增合同', type: 'contract', labelValue: 6, field: 'contractNum', icon: 'wk-contract', num: '', rate: '', status: '', color: '#4A5BFD' },
        { label: '合同金额(元)', title: '合同金额', type: 'contract', labelValue: 6, field: 'contractMoneyNum', icon: 'wk-receivables', num: '', rate: '', status: '', color: '#19B5F6' },
        { label: '商机金额(元)', title: '商机金额', type: 'business', labelValue: 5, field: 'businessMoneyNum', icon: 'wk-icon-opportunities', num: '', rate: '', status: '', color: '#AD5CFF' },
        { label: '回款金额(元)', title: '回款金额', type: 'receivables', labelValue: 7, field: 'receivablesMoneyNum', icon: 'wk-receivables', num: '', rate: '', status: '', color: '#FFB940' },
        { label: '新增跟进记录(条)', title: '新增跟进记录', type: 'activity', labelValue: '', field: 'recordNum', icon: 'wk-record', num: '', rate: '', status: '', color: '#4A5BFD' }
      ],
      rangeOptions: [
        { label: '仅本人', command: 1 },
