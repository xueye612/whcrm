  ...
  <el-dialog
    ...
    <div class="handle-box">
      ...
      <flexbox
        v-if="isCreate"
        class="handle-item">
        <div class="handle-item-name">财务权限：</div>
        <el-checkbox v-model="financeAuth">查看金额</el-checkbox>
      </flexbox>
      ...
      <flexbox
        ...
        <el-checkbox-group v-model="addsTypes">
          ...
          <el-checkbox label="customer_ledger">台账</el-checkbox>
          <el-checkbox label="finance_record">收支</el-checkbox>
        </el-checkbox-group>
      </flexbox>
      <flexbox
        v-if="isCreate"
    ...
    handleConfirm() {
      ...
      if (!this.members && this.usersList.length === 0) {
        ...
        if (this.isCreate) {
          ...
          params.finance_auth = this.financeAuth ? 1 : 0
          // request = {
