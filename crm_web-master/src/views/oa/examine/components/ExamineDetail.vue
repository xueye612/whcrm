            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <flexbox justify="center">
                  <el-button
                    type="text"
                    @click.native="handleFile('preview', scope.row.imgList, 0)">{{ scope.row.imgList ? scope.row.imgList.length : 0 }}张</el-button>
                </flexbox>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
    ...
    checkRelatedDetail(crmType, item) {
      this.relatedID = item[crmType + '_id'] || item.id
