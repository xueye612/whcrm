      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          const params = {
            ...
            owner_structure_ids: this.formData.dep.dep && this.formData.dep.dep
              .map(item => item.id),

            owner_user_ids: this.formData.dep.staff && this.formData.dep.staff
              .map(item => item.id)

          }

          if (this.action.type == 'update') {
            params.announcement_id = this.action.id
          }
